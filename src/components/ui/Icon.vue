<template>
  <fragment>
    <svg v-if="icon === 'instagram'" class="icon" :class="iconClass" xmlns="http://www.w3.org/2000/svg" :width="computedSize" :height="computedSize" viewBox="0 0 101.996 102">
      <defs>
    ...
    <svg v-else class="icon" :class="iconClass" :style="{width: iconSize, height: iconSize, color, ...extraStyle}">
